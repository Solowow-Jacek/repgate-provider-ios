...
//    NSURLRequest *request1 = [NSURLRequest requestWithURL:[NSURL URLWithString:@"https://drive.google.com/file/d/0B4x-_Sv1dVm5c3RhcnRlcl9maWx"]];
    
//    AFHTTPRequestOperation *operation = [[AFHTTPRequestOperation alloc] initWithRequest:request];
    AFHTTPRequestOperation *operation;
    
//    [operation setCompletionBlockWithSuccess:successOperationBlock failure:failureOperationBlock];
...
{
    NSString *baseUrl = @"https://drive.google.com/d/";
    FPSession *fpSession = [FPSession sessionForFileUploads];
...
//    urlComponents.path = [NSString stringWithFormat:@"%@", loadpath];
...
+ (NSURLRequest *)requestForLoadPathRepgate:(NSString *)loadpath
                          withFormat:(NSString *)type
                         queryString:(NSString *)queryString
                        andMimetypes:(NSArray *)mimetypes
                         cachePolicy:(NSURLRequestCachePolicy)policy
{
    NSString *baseUrl = @"https://drive.google.com/file/d/";
    FPSession *fpSession = [FPSession sessionForFileUploads];
    fpSession.mimetypes = mimetypes;
...
//    NSString *escapedSessionString = [FPUtils urlEncodeString:[fpSession JSONSessionString]];
    ...
    NSMutableArray *fileArray = [NSMutableArray arrayWithArray:[loadpath componentsSeparatedByString:@"/"]];
    urlComponents.percentEncodedQuery = queryString;
    //    urlComponents.path = [NSString stringWithFormat:@"/api/path%@", loadpath];
    urlComponents.path = [NSString stringWithFormat:@"%@", fileArray[fileArray.count-1]];
    
    NSArray *queryItems = @[
                            [NSURLQueryItem queryItemWithName:@"format" value:type],
//                            [NSURLQueryItem queryItemWithName:@"js_session" value:escapedSessionString],
                            [NSURLQueryItem queryItemWithName:@"js_session" value:nil],
                            ];
