...
- (UITableViewCell *) tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell setData:salesArray[indexPath.row]];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [self performSegueWithIdentifier:@"gotoSalesDetailSegue" sender:self];
}
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    if ([segue.identifier isEqualToString:@"gotoSalesDetailSegue"]) {
        SalesDetailViewController *vc = [segue destinationViewController];
        ClientInfo *clientInfo = salesArray[currentIndex.row];
        vc.salesInfo = clientInfo;
    }
}
